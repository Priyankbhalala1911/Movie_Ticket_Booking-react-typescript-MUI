...
import Logo from "../../assets/Images/Logos/navbarLogo.svg";
import Download1 from "../../assets/Images/DownloadImage/Google Play.svg";
import Download2 from "../../assets/Images/DownloadImage/App store.svg";
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: "18px" }}>
            ...
            <Box sx={{ display: "flex", gap: "24px" }}>
              ...
              <IconButton sx={{ padding: 0 }} color="primary">
                <img src={Download2} alt="App store" />
              </IconButton>
            </Box>
          </Box>
          <Box>
