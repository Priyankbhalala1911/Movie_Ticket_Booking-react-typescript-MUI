...
import Logo1 from "../../assets/Images/Studio/xxi.svg";
import Logo2 from "../../assets/Images/Studio/CGV.svg";
import Logo3 from "../../assets/Images/Studio/cinemapolis.svg";

const Studio = [
  { label: "XXI", value: <img src={Logo1} alt="logo1" width={35} /> },
  { label: "2D", value: "2D" },
  { label: "CGV", value: <img src={Logo2} alt="logo2" width={35} /> },
  { label: "Gold Class 2D", value: "Gold Class 2D" },
  { label: "Velvet 2D", value: "Velvet 2D" },
  { label: "Cinemapolis", value: <img src={Logo3} alt="logo3" width={75} /> },
